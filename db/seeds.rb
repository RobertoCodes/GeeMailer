...
e7 = Email.create!(subject: "Subject3", body: "Nope, can't make it", sender_id: 3,
parent_email_id: e1.id, email_type: "received", category_id: 2, recipient_email: "frank@gmail.com",
starred: false, trashed: true)

e8 = Email.create!(subject: "Subject4", body: "Sure, I'm down", sender_id: 5,
parent_email_id: e1.id, email_type: "received", category_id: 2, recipient_email: "joe@gmail.com",
starred: true, trashed: false)

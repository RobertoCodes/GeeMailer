...
c6 = Conversation.create!(user_id: u1.id)
...
#
#
c1 = Contact.create!(name: "Mrs. Claus", owner_id: santa.id,
  contact_email_address: "snowqueen@geemailer.com")

c2 = Contact.create!(name: "Head Elf", owner_id: santa.id,
  contact_email_address: "northpolebuilder@geemailer.com")

c3 = Contact.create!(name: "George Clooney", owner_id: santa.id,
  contact_email_address: "g.cloon@geemailer.com")
